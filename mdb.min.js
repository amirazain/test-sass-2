...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (! function (e) {
        ...
        if (!e.jQuery) {
            ...
            n.isWindow = function (e) {
                ...
                if (i) {
                    if (s)
                        for (; a > r && (o = n.apply(e[r], i), o !== !1); r++);
                    else
                        for (r in e)
                            if (o = n.apply(e[r], i), o === !1) break
                } else if (s)
                    for (; a > r && (o = n.call(e[r], r, e[r]), o !== !1); r++);
                else
                    for (r in e)
                        if (o = n.call(e[r], r, e[r]), o === !1) break;
                return e
                ...
                if (e) {
                    i = (i || "fx") + "queue";
                    var a = n.data(e, i);
                    return o ? (!a || n.isArray(o) ? a = n.data(e, i, r(o)) : a.push(o), a) : a || []
                }
        ...
        return function (e, t, n, i) {
            ...
            function l(e, n, i, o) {
                ...
                function d() {
                    for (var t = 0; w > t; ++t) T[t] = l(t * b, e, i)
                }

                function p(t, n, o) {
                    var r, a, s = 0;
                    do a = n + (o - n) / 2, r = l(a, e, i) - t, r > 0 ? o = a : n = a; while (Math.abs(r) > g && ++s < y);
                    return a
                }

                function f(t) {
                    for (var n = 0, o = 1, r = w - 1; o != r && T[o] <= t; ++o) n += b;
                    --o;
                    var a = (t - T[o]) / (T[o + 1] - T[o]),
                        s = n + a * b,
                        l = u(s, e, i);
                    return l >= v ? c(t, s) : 0 == l ? s : p(t, n, n + b)
                }
            ...
            function u(e, t) {
                var n = e;
                return m.isString(e) ? w.Easings[e] || (n = !1) : n = m.isArray(e) && 1 === e.length ? s.apply(null, e) : m.isArray(e) && 2 === e.length ? b.apply(null, e.concat([t])) : !(!m.isArray(e) || 4 !== e.length) && l.apply(null, e), n === !1 && (n = w.Easings[w.defaults.easing] ? w.defaults.easing : y), n
            }
            ...
            function c(e) {
                if (e) {
                    ...
                    n > 1e4 && (w.State.calls = o(w.State.calls));
                    for (var r = 0; n > r; r++)
                        if (w.State.calls[r]) {
                            var s = w.State.calls[r],
                                ...
                                h = !!f,
                                v = null;
                            f || (f = w.State.calls[r][3] = t - 16);
                            for (var g = Math.min((t - f) / u.duration, 1), y = 0, b = l.length; b > y; y++) {
                                var C = l[y],
                                    S = C.element;
                                if (a(S)) {
                                    var E = !1;
                                    ...
                                    for (var P in C)
                                        if ("element" !== P) {
                                            var k, A = C[P],
                                                O = m.isString(A.easing) ? w.Easings[A.easing] : A.easing;
                                            if (1 === g) k = A.endValue;
                                            else {
                            ...
                            u.display !== i && "none" !== u.display && (w.State.calls[r][2].display = !1), u.visibility !== i && "hidden" !== u.visibility && (w.State.calls[r][2].visibility = !1), u.progress && u.progress.call(s[1], s[1], g, Math.max(0, f + u.duration - t), f, v), 1 === g && d(r)
                        }
                }
            ...
            function d(e, t) {
                ...
                for (var n = w.State.calls[e][0], o = w.State.calls[e][1], r = w.State.calls[e][2], s = w.State.calls[e][4], l = !1, u = 0, c = n.length; c > u; u++) {
                    var d = n[u].element;
            ...
            var b = function () {
                ...
                return function e(t, i, o) {
                    var r, a, s, l = {
                        ...
                        d = 1e-4,
                        p = .016;
                    for (t = parseFloat(t) || 500, i = parseFloat(i) || 20, o = o || null, l.tension = t, l.friction = i, r = null !== o, r ? (c = e(t, i), a = c / o * p) : a = p; s = n(s || l, a), u.push(1 + s.x), c += 16, Math.abs(s.x) > d && Math.abs(s.v) > d;);
                    return r ? function (e) {
                ...
                Hooks: {
                    ...
                    injectValue: function (e, t, n) {
                        ...
                        if (i) {
                            var o, r, a = i[0],
                                s = i[1];
                            return n = x.Hooks.cleanRootPropertyValue(a, n), o = n.toString().match(x.RegEx.valueSplit), o[s] = t, r = o.join(" ")
                        }
                        return n
                    }
                },
                                ...
                                switch (e) {
                                    ...
                                    case "inject":
                                        ...
                                        switch (t.substr(0, t.length - 1)) {
                                            ...
                                            case "scal":
                                            case "scale":
                                                w.State.isAndroid && a(n).transformCache[t] === i && 1 > o && (o = 1), r = !/(\d)$/i.test(o);
                                                break;
                                            case "skew":
                                                r = !/(deg|\d)$/i.test(o);
                                                break;
            ...
            x.Hooks.register(), x.Normalizations.register(), w.hook = function (e, t, n) {
                ...
                return e = r(e), p.each(e, function (e, r) {
                    if (a(r) === i && w.init(r), n === i) o === i && (o = w.CSS.getPropertyValue(r, t));
                    else {
                        var s = w.CSS.setPropertyValue(r, t, n);
                        "transform" === s[0] && w.CSS.flushTransformCache(r), o = s
                    }
                }), o
            };
            var C = function () {
                ...
                function o() {
                    function e(e) {
                        ...
                        function g() {
                            ...
                            if (o && i) l.emToPx = L.lastEmToPx, l.percentToPxWidth = L.lastPercentToPxWidth, l.percentToPxHeight = L.lastPercentToPxHeight;
                                ...
                                }), w.CSS.setPropertyValue(u, "paddingLeft", s + "em"), l.percentToPxWidth = L.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / s, l.percentToPxHeight = L.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / s, l.emToPx = L.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / s, e.myParent.removeChild(u)
                            }
                            return null === L.remToPx && (L.remToPx = parseFloat(x.getPropertyValue(n.body, "fontSize")) || 16), null === L.vwToPx && (L.vwToPx = parseFloat(t.innerWidth) / 100, L.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = L.remToPx, l.vwToPx = L.vwToPx, l.vhToPx = L.vhToPx, w.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
                        }
                        if (s.begin && 0 === S) try {
                            s.begin.call(h, h)
                        } catch (e) {
                        ...
                        if ("scroll" === k) {
                            var b, C, E, I = /^x$/i.test(s.axis) ? "Left" : "Top",
                                A = parseFloat(s.offset) || 0;
                            s.container ? m.isWrapped(s.container) || m.isNode(s.container) ? (s.container = s.container[0] || s.container, b = s.container["scroll" + I], E = b + p(r).position()[I.toLowerCase()] + A) : s.container = null : (b = w.State.scrollAnchor[w.State["scrollProperty" + I]], C = w.State.scrollAnchor[w.State["scrollProperty" + ("Left" === I ? "Top" : "Left")]], E = p(r).offset()[I.toLowerCase()] + A), l = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: b,
                                    currentValue: b,
                            ...
                            var O = p.extend(!0, {}, a(r).tweensContainer);
                            for (var M in O)
                                if ("element" !== M) {
                                    var D = O[M].startValue;
                                    O[M].startValue = O[M].currentValue = O[M].endValue, O[M].endValue = D, m.isEmptyObject(y) || (O[M].easing = s.easing), w.debug && console.log("reverse tweensContainer (" + M + "): " + JSON.stringify(O[M]), r)
                                }
                            l = O
                        } else if ("start" === k) {
                            var O;
                            a(r).tweensContainer && a(r).isAnimating === !0 && (O = a(r).tweensContainer), p.each(v, function (e, t) {
                            ...
                            for (var F in v) {
                                ...
                                var H = x.Hooks.getRoot(F),
                                    j = !1;
                                if (a(r).isSVG || "tween" === H || x.Names.prefixCheck(H)[1] !== !1 || x.Normalizations.registered[H] !== i) {
                                    (s.display !== i && null !== s.display && "none" !== s.display || s.visibility !== i && "hidden" !== s.visibility) && /opacity|filter/.test(F) && !z && 0 !== R && (z = 0), s._cacheValues && O && O[F] ? (z === i && (z = O[F].endValue + O[F].unitType), j = a(r).rootPropertyValueCache[H]) : x.Hooks.registered[F] ? z === i ? (j = x.getPropertyValue(r, H), z = x.getPropertyValue(r, F, j)) : j = x.Hooks.templates[H][1] : z === i && (z = x.getPropertyValue(r, F));
                                    var W, q, $, Y = !1;
                                    if (W = f(F, z), z = W[0], $ = W[1], W = f(F, R), R = W[0].replace(/^([+-\/*])=/, function (e, t) {
                                            return Y = t, ""
                                        }), q = W[1], z = parseFloat(z) || 0, R = parseFloat(R) || 0, "%" === q && (/^(fontSize|lineHeight)$/.test(F) ? (R /= 100, q = "em") : /^scale/.test(F) ? (R /= 100, q = "") : /(Red|Green|Blue)$/i.test(F) && (R = R / 100 * 255, q = "")), /[\/*]/.test(Y)) q = $;
                                    else if ($ !== q && 0 !== z)
                                        if (0 === R) q = $;
                                        else {
                                            o = o || g();
                                            var B = /margin|padding|left|right|width|text|word|letter/i.test(F) || /X$/.test(F) || "x" === F ? "x" : "y";
                                            switch ($) {
                                                case "%":
                                    ...
                                    l[F] = {
                                        ...
                                        unitType: q,
                                        easing: _
                                    }, w.debug && console.log("tweensContainer (" + F + "): " + JSON.stringify(l[F]), r)
                                } else w.debug && console.log("Skipping [" + H + "] due to a lack of browser support.")
                            }
                            l.element = r
                        }
                        l.element && (x.Values.addClass(r, "velocity-animating"), V.push(l), "" === s.queue && (a(r).tweensContainer = l, a(r).opts = s), a(r).isAnimating = !0, S === T - 1 ? (w.State.calls.push([V, h, s, null, P.resolver]), w.State.isTicking === !1 && (w.State.isTicking = !0, c())) : S++)
                    }
                    var o, r = this,
                        s = p.extend({}, w.defaults, y),
                        l = {};
                    switch (a(r) === i && w.init(r), parseFloat(s.delay) && s.queue !== !1 && p.queue(r, s.queue, function (e) {
                        w.velocityQueueEntryFlag = !0, a(r).delayTimer = {
                    ...
                    w.mock !== !1 && (w.mock === !0 ? s.duration = s.delay = 1 : (s.duration *= parseFloat(w.mock) || 1, s.delay *= parseFloat(w.mock) || 1)), s.easing = u(s.easing, s.duration), s.begin && !m.isFunction(s.begin) && (s.begin = null), s.progress && !m.isFunction(s.progress) && (s.progress = null), s.complete && !m.isFunction(s.complete) && (s.complete = null), s.display !== i && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = w.CSS.Values.getDisplayType(r))), s.visibility !== i && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && w.State.isMobile && !w.State.isGingerbread, s.queue === !1 ? s.delay ? setTimeout(e, s.delay) : e() : p.queue(r, s.queue, function (t, n) {
                ...
                var s, l, f, h, v, y, b = arguments[0] && (arguments[0].p || p.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || m.isString(arguments[0].properties));
                if (m.isWrapped(this) ? (s = !1, f = 0, h = this, l = this) : (s = !0, f = 1, h = b ? arguments[0].elements || arguments[0].e : arguments[0]), h = r(h)) {
                    b ? (v = arguments[0].properties || arguments[0].p, y = arguments[0].options || arguments[0].o) : (v = arguments[f], y = arguments[f + 1]);
                    var T = h.length,
                        S = 0;
                            ...
                            if (!p.isPlainObject(v) || m.isEmptyObject(v)) {
                                if (m.isString(v) && w.Redirects[v]) {
                                    ...
                                    return O.backwards === !0 && (h = p.extend(!0, [], h).reverse()), p.each(h, function (e, t) {
                                        parseFloat(O.stagger) ? O.delay = D + parseFloat(O.stagger) * e : m.isFunction(O.stagger) && (O.delay = D + O.stagger.call(t, e, T)), O.drag && (O.duration = parseFloat(M) || (/^(callout|transition)/.test(v) ? 1e3 : g), O.duration = Math.max(O.duration * (O.backwards ? 1 - e / T : (e + 1) / T), .75 * O.duration, 200)), w.Redirects[v].call(t, t, O || {}, e, T, h, P.promise ? P : i)
                                    }), e()
                                }
            ...
            return w.State.isMobile || n.hidden === i || n.addEventListener("visibilitychange", function () {
            ...
            }), e.Velocity = w, e !== t && (e.fn.velocity = C, e.fn.velocity.defaults = w.defaults), p.each(["Down", "Up"], function (e, t) {
                w.Redirects["slide" + t] = function (e, n, o, r, a, s) {
                    var l = p.extend({}, n),
                        u = l.begin,
                        c = l.complete,
                        d = {
                ...
                w.Redirects["fade" + t] = function (e, n, o, r, a, s) {
                    var l = p.extend({}, n),
                        u = {
                            opacity: "In" === t ? 1 : 0
                        },
    ...
    function () {
        ...
        t = function () {
            ...
            return e.prototype.get = function (e) {
                var t, n, i, o, r;
                for (r = this.keys, t = i = 0, o = r.length; i < o; t = ++i)
    ...
    function (e, t) {
        ...
        function r(e) {
            var n, i, o = {
                ...
                r = e && e.ownerDocument;
            return n = r.documentElement, "undefined" != typeof e.getBoundingClientRect && (o = e.getBoundingClientRect()), i = t(r), {
            ...
            this.each(function () {
                ...
                if (i(), a.after(u), s.hover) {
                    ...
                    a.unbind("click." + a.attr("id")), a.on("mouseenter", function (e) {
                        ...
                        e(n).closest(".dropdown-content").is(u) || (u.stop(!0, !0), r(), c = !1)
                    }), u.on("mouseleave", function (t) {
                        var n = t.toElement || t.relatedTarget;
                        e(n).closest(".dropdown-button").is(a) || (u.stop(!0, !0), r(), c = !1)
                    })
...
dropdownSelectors.on({
    ...
    function (e, t, n, i) {
        ...
        function S(e) {
            ...
            return new(t = n ? n : Te ? _ : Se ? j : Ce ? q : R)(e, E)
        }
        ...
        function I(e, t) {
            ...
            var r = n.firstInput,
                ...
                l = t.center = O(i);
            t.timeStamp = ge(), t.deltaTime = t.timeStamp - r.timeStamp, t.angle = L(s, l), t.distance = F(s, l), P(n, t), t.offsetDirection = D(t.deltaX, t.deltaY);
            var u = M(t.deltaTime, t.deltaX, t.deltaY);
            t.overallVelocityX = u.x, t.overallVelocityY = u.y, t.overallVelocity = ve(u.x) > ve(u.y) ? u.x : u.y, t.scale = a ? N(a.pointers, i) : 1, t.rotation = a ? V(a.pointers, i) : 0, t.maxPointers = n.prevInput ? t.pointers.length > n.prevInput.maxPointers ? t.pointers.length : n.prevInput.maxPointers : t.pointers.length, k(n, t);
            var c = e.element;
        ...
        function P(e, t) {
            var n = t.center,
                ...
                o = e.prevDelta || {},
                r = e.prevInput || {};
            t.eventType !== Oe && r.eventType !== De || (o = e.prevDelta = {
                x: r.deltaX || 0,
                y: r.deltaY || 0
            }, i = e.offsetDelta = {
                x: n.x,
        ...
        function k(e, t) {
            ...
            if (t.eventType != Fe && (l > Ae || s.velocity === i)) {
                var u = t.deltaX - s.deltaX,
                    c = t.deltaY - s.deltaY,
                    d = M(l, u, c);
                o = d.x, r = d.y, n = ve(d.x) > ve(d.y) ? d.x : d.y, a = D(u, c), e.lastInterval = t
            } else n = s.velocity, o = s.velocityX, r = s.velocityY,
                a = s.direction;
        ...
        function D(e, t) {
            return e === t ? Le : ve(e) >= ve(t) ? e < 0 ? Ve : Ne : t < 0 ? Re : _e
        }
        ...
        function V(e, t) {
            return L(t[1], t[0], qe) + L(e[1], e[0], qe)
        }

        function N(e, t) {
            return F(t[0], t[1], qe) / F(e[0], e[1], qe)
        }

        function R() {
            this.evEl = Ye, this.evWin = Be, this.pressed = !1, T.apply(this, arguments)
        }

        function _() {
            this.evEl = Ue, this.evWin = Ge, T.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function z() {
            this.evTarget = Ke, this.evWin = Je, this.started = !1, T.apply(this, arguments)
        }

        function H(e, t) {
            var n = y(e.touches),
                i = y(e.changedTouches);
            return t & (De | Fe) && (n = w(n.concat(i), "identifier", !0)), [n, i]
        }
        ...
        function W(e, t) {
            var n = y(e.touches),
                i = this.targetIds;
            if (t & (Oe | Me) && 1 === n.length) return i[n[0].identifier] = !0, [n, n];
            ...
            for (o = 0; o < a.length;) i[a[o].identifier] && s.push(a[o]), t & (De | Fe) && delete i[a[o].identifier], o++;
        ...
        function $(e, t) {
            e & Oe ? (this.primaryTouch = t.changedPointers[0].identifier, Y.call(this, t)) : e & (De | Fe) && Y.call(this, t)
        }
        ...
        function Z(e) {
            ...
            var t = m(e, ct),
                n = m(e, dt);
            return t && n ? ut : t || n ? t ? ct : dt : m(e, lt) ? lt : st
        }
        ...
        function K(e) {
            return e == _e ? "down" : e == Re ? "up" : e == Ve ? "left" : e == Ne ? "right" : ""
        }
        ...
        function le(e, t) {
            this.options = de({}, se.defaults, t || {}), this.options.inputTarget = this.options.inputTarget || e, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = e, this.input = S(this), this.touchAction = new X(this, this.options.touchAction), ue(this, !0), a(this.options.recognizers, function (e) {
        ...
        var ye = s(function (e, t, n) {
            ...
            Te = b(e, "PointerEvent") !== i,
            Se = Ce && xe.test(navigator.userAgent),
            Ee = "touch",
            Ie = "pen",
            Pe = "mouse",
            ke = "kinect",
        ...
        l(R, T, {
            handler: function (e) {
                var t = $e[e.type];
                t & Oe && 0 === e.button && (this.pressed = !0), t & Me && 1 !== e.which && (t = De), this.pressed && (t & De && (this.pressed = !1), this.callback(this.manager, t, {
                    pointers: [e],
                    changedPointers: [e],
                    pointerType: Pe,
                    srcEvent: e
        ...
        e.MSPointerEvent && !e.PointerEvent && (Ue = "MSPointerDown", Ge = "MSPointerMove MSPointerUp MSPointerCancel"), l(_, T, {
            handler: function (e) {
                var t = this.store,
                    n = !1,
                ...
                o & Oe && (0 === e.button || a) ? s < 0 && (t.push(e), s = t.length - 1) : o & (De | Fe) && (n = !0), s < 0 || (t[s] = e, this.callback(this.manager, o, {
                    pointers: t,
                    changedPointers: [e],
                    pointerType: r,
                    srcEvent: e
        ...
        l(z, T, {
            handler: function (e) {
                ...
                if (t === Oe && (this.started = !0), this.started) {
                    ...
                    t & (De | Fe) && n[0].length - n[1].length === 0 && (this.started = !1), this.callback(this.manager, t, {
                        pointers: n[0],
                        changedPointers: n[1],
                        pointerType: Ee,
                        srcEvent: e
        ...
        X.prototype = {
            ...
            preventDefaults: function (e) {
                ...
                return a && r ? void 0 : o || r && n & ze || a && n & He ? this.preventSrc(t) : void 0
            },
        ...
        G.prototype = {
            ...
            requireFailure: function (e) {
                ...
                return e = J(e, this), g(t, e) === -1 && (t.push(e), e.requireFailure(this)), this
            },
            ...
            emit: function (e) {
                ...
                var n = this,
                    i = this.state;
                i < vt && t(n.options.event + Q(i)), t(n.options.event), e.additionalEvent && t(e.additionalEvent), i >= vt && t(n.options.event + Q(i))
            },
            tryEmit: function (e) {
            ...
            recognize: function (e) {
                var t = de({}, e);
                return c(this.options.enable, [this, t]) ? (this.state & (gt | yt | wt) && (this.state = ft), this.state = this.process(t), void(this.state & (ht | mt | vt | yt) && this.tryEmit(t))) : (this.reset(), void(this.state = wt))
            },
            process: function (e) {},
            ...
            process: function (e) {
                var t = this.state,
                    ...
                    i = t & (ht | mt),
                    o = this.attrTest(e);
                return i && (n & Fe || !o) ? t | yt : i || o ? n & De ? t | vt : t & ht ? t | mt : ht : wt
            }
        }), l(te, ee, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function () {
                var e = this.options.direction,
                    t = [];
                return e & ze && t.push(dt), e & He && t.push(ct), t
            },
            directionTest: function (e) {
                var t = this.options,
                    ...
                    r = e.deltaX,
                    a = e.deltaY;
                return o & t.direction || (t.direction & ze ? (o = 0 === r ? Le : r < 0 ? Ve : Ne, n = r != this.pX, i = Math.abs(e.deltaX)) : (o = 0 === a ? Le : a < 0 ? Re : _e, n = a != this.pY, i = Math.abs(e.deltaY))), e.direction = o, n && i > t.threshold && o & t.direction
            },
            attrTest: function (e) {
            ...
            process: function (e) {
                ...
                if (this._input = e, !i || !n || e.eventType & (De | Fe) && !r) this.reset();
                else if (e.eventType & Oe) this.reset(), this._timer = o(function () {
                    this.state = gt, this.tryEmit()
                }, t.time, this);
                else if (e.eventType & De) return gt;
                return wt
            },
            reset: function () {
            ...
            emit: function (e) {
                this.state === gt && (e && e.eventType & De ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = ge(), this.manager.emit(this.options.event, this._input)))
            }
        }), l(oe, ee, {
            defaults: {
                event: "rotate",
            ...
            attrTest: function (e) {
                ...
                return n & (ze | He) ? t = e.overallVelocity : n & ze ? t = e.overallVelocityX : n & He && (t = e.overallVelocityY), this._super.attrTest.call(this, e) && n & e.offsetDirection && e.distance > this.options.threshold && e.maxPointers == this.options.pointers && ve(t) > this.options.velocity && e.eventType & De
            },
            emit: function (e) {
        ...
        Ct.Hammer = se, "function" == typeof define && define.amd ? define(function () {
            return se
    ...
    function (e) {
        e(document).ready(function () {
            ...
            e(document).on("change", a, function (t) {
                ...
                n.length <= 0 && (n = e('<span class="thumb"><span class="value"></span></span>'), e(this).after(n)), n.find(".value").html(e(this).val()), s = !0, e(this).addClass("active"), n.hasClass("active") || n.velocity({
                    ...
                    duration: 300,
                    easing: "easeOutExpo"
                }), "input" !== t.type && (r = void 0 === t.pageX || null === t.pageX ? t.originalEvent.touches[0].pageX - e(this).offset().left : t.pageX - e(this).offset().left, r < 0 ? r = 0 : r > i && (r = i), n.addClass("active").css("left", r)), n.find(".value").html(e(this).val())
            ...
            e(this).each(function () {
                ...
                if (!i.hasClass("browser-default")) {
                    ...
                    var l = e('<ul id="select-options-' + a + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'),
                        ...
                        f = function () {
                            var t = e(this).closest("ul"),
                                n = e(this).val(),
                                i = t.find("li").find("span.filtrable");
                            i.each(function () {
                                if ("string" == typeof this.outerText) {
                                    var t = this.outerText.toLowerCase();
                                    t.indexOf(n.toLowerCase()) === -1 ? (e(this).hide(), e(this).parent().hide()) : (e(this).show(), e(this).parent().show())
                                }
                            })
                        },
                        h = function () {
                    ...
                    u.length && u.each(function () {
                        if (e(this).is("option")) o ? v(i, e(this), "multiple") : v(i, e(this));
                        ...
                        e(this).click(function (a) {
                            if (!e(this).hasClass("disabled") && !e(this).hasClass("optgroup")) {
                                ...
                                o ? (e('input[type="checkbox"]', this).prop("checked", function (e, t) {
                                    return !t
                                }), s = n(c, e(this).index() - 1, i), w.trigger("focus")) : (l.find("li").removeClass("active"), e(this).toggleClass("active"), w.val(e(this).text())), b(l, e(this)), i.find("option").eq(r).prop("selected", s), i.trigger("change"), "undefined" != typeof t && t()
                            }
                            a.stopPropagation()
                        })
                    }), i.wrap(s);
                    var g = e('<span class="caret">&#9660;</span>');
                    i.is(":disabled") && g.addClass("disabled");
                    var y = p.replace(/"/g, "&quot;"),
                        w = e('<input type="text" class="select-dropdown" readonly="true" ' + (i.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + a + '" value="' + y + '"/>');
                    i.before(w), w.before(g), w.after(l), i.is(":disabled") || w.dropdown({
                        hover: !1,
                        closeOnClick: !1
                        ...
                        o || m || e(this).trigger("close"), l.find("li.selected").removeClass("selected")
                    }), !o && m && l.find("li").on("click", function () {
                        w.trigger("close")
                    }), l.hover(function () {
                        d = !0
                    }, function () {
                    ...
                    var b = function (t, n) {
                        ...
                        C = function (t) {
                            ...
                            if (40 == t.which && !l.is(":visible")) return void w.trigger("open");
                            if (13 != t.which || l.is(":visible")) {
                                ...
                                if (13 == t.which) {
                                    ...
                                    s && (e(s).trigger("click"), o || w.trigger("close"))
                                }
                                40 == t.which && (a = l.find("li.selected").length ? l.find("li.selected").next("li:not(.disabled)")[0] : l.find("li:not(.disabled)")[0], b(l, a)), 27 == t.which && w.trigger("close"), 38 == t.which && (a = l.find("li.selected").prev("li:not(.disabled)")[0], a && b(l, a)), setTimeout(function () {
                                    x = []
                                }, 1e3)
                            }
                        };
        ...
        var e = function (e, t, n, i) {
            ...
            o.extend(l, i);
            var u, c, d, p, f, h, m, v, g, y, w, b, x, C, T, S, E, I, P, k, A, O, M, D, F, L, V, N, R, _, z, H, j, W, q, $, Y, B, X, Z, U, G, Q, K, J, ee, te, ne, ie, oe, re, ae, se, le, ue, ce, de = function () {
                    return {
                        x: 0,
                        y: 0
                    }
                ...
                Me = function (e, t, n, i, o) {
                    (!Te || o && o !== r.currItem) && (i /= o ? o.fitRatio : r.currItem.fitRatio), e[O] = b + t + "px, " + n + "px" + x + " scale(" + i + ")"
                },
                De = function (e) {
                    ie && (e && (y > r.currItem.fitRatio ? Te || (pn(r.currItem, !1, !0),
                        Te = !0) : Te && (pn(r.currItem), Te = !1)), Me(ie, he.x, he.y, y))
                },
                Fe = function (e) {
                ...
                ze = null,
                He = function () {
                    ze && (o.unbind(document, "mousemove", He), o.addClass(e, "pswp--has_mouse"), l.mouseUsed = !0, ke("mouseUsed")), ze = setTimeout(function () {
                        ze = null
                    }, 100)
                },
                je = function () {
                    o.bind(document, "keydown", r), z.transform && o.bind(r.scrollWrap, "click", r), l.mouseUsed || o.bind(document, "mousemove", He), o.bind(window, "resize scroll", r), ke("bindEvents")
                },
                We = function () {
                    o.unbind(window, "resize", r), o.unbind(window, "scroll", g.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", He), z.transform && o.unbind(r.scrollWrap, "click", r), B && o.unbind(window, m, r), ke("unbindEvents")
                },
                qe = function (e, t) {
                ...
                Ue = function (e) {
                    e && (U || Z || oe || $) && (e.preventDefault(), e.stopPropagation())
                },
                Ge = function () {
                ...
                Ke = 0,
                Je = function (e) {
                    Qe[e] && (Qe[e].raf && L(Qe[e].raf), Ke--, delete Qe[e])
                },
                et = function (e) {
                    Qe[e] && Je(e), Qe[e] || (Ke++, Qe[e] = {})
                },
                tt = function () {
                ...
                nt = function (e, t, n, i, o, r, a) {
                    ...
                    var u = function () {
                        if (Qe[e]) {
                            if (s = Ae() - l, s >= i) return Je(e), r(n), void(a && a());
                            r((n - t) * o(s / i) + t), Qe[e].raf = F(u)
                        }
                    };
                    u()
                },
                it = {
                    ...
                    setScrollOffset: function (e, t) {
                        ge.x = e, _ = ge.y = t, ke("updateScrollOffset", ge)
                    },
                    applyZoomPan: function (e, t, n, i) {
                        he.x = t, he.y = n, y = e, De(i)
                    },
                    init: function () {
                        if (!u && !c) {
                            var n;
                            r.framework = o, r.template = e, r.bg = o.getChildByClass(e, "pswp__bg"), V = e.className, u = !0, z = o.detectFeatures(), F = z.raf, L = z.caf, O = z.transform, R = z.oldIE, r.scrollWrap = o.getChildByClass(e, "pswp__scroll-wrap"), r.container = o.getChildByClass(r.scrollWrap, "pswp__container"), f = r.container.style, r.itemHolders = S = [{
                                ...
                                wrap: 0,
                                index: -1
                            }], S[0].el.style.display = S[2].el.style.display = "none", Xe(), g = {
                                resize: r.updateSize,
                                scroll: Ge,
                                keydown: Ze,
                                click: Ue
                            ...
                            for (z.animationName && z.transform && !i || (l.showAnimationDuration = l.hideAnimationDuration = 0), n = 0; n < xe.length; n++) r["init" + xe[n]]();
                            if (t) {
                                var a = r.ui = new t(r, o);
                                a.init()
                            }
                            ke("firstUpdate"), p = p || l.index || 0, (isNaN(p) || 0 > p || p >= Jt()) && (p = 0), r.currItem = Kt(p), (z.isOldIOSPhone || z.isOldAndroid) && (be = !1), e.setAttribute("aria-hidden", "false"), l.modal && (be ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")), void 0 === _ && (ke("initialLayout"), _ = N = o.getScrollY());
                            var d = "pswp--open ";
                            for (l.mainClass && (d += l.mainClass + " "), l.showHideOpacity && (d += "pswp--animate_opacity "), d += D ? "pswp--touch" : "pswp--notouch", d += z.animationName ? " pswp--css_animation" : "", d += z.svg ? " pswp--svg" : "", o.addClass(e, d), r.updateSize(), h = -1, we = null, n = 0; s > n; n++) Le((n + h) * ye.x, S[n].el.style);
                            R || o.bind(r.scrollWrap, v, r), Pe("initialZoomInEnd", function () {
                                r.setContent(S[0], p - 1), r.setContent(S[2], p + 1), S[0].el.style.display = S[2].el.style.display = "block", l.focus && e.focus(), je()
                            }), r.setContent(S[1], p), r.updateCurrItem(), ke("afterInit"), be || (C = setInterval(function () {
                                Ke || B || J || y !== r.currItem.initialZoomLevel || r.updateSize()
                            }, 1e3)), o.addClass(e, "pswp--visible")
                        }
                    },
                    close: function () {
                        u && (u = !1, c = !0, ke("close"), We(), tn(r.currItem, null, !0, r.destroy))
                    },
                    destroy: function () {
                        ke("destroy"), Zt && clearTimeout(Zt), e.setAttribute("aria-hidden", "true"), e.className = V, C && clearInterval(C), o.unbind(r.scrollWrap, v, r), o.unbind(window, "scroll", r), St(), tt(), Ie = null
                    },
                    panTo: function (e, t, n) {
                        n || (e > ne.min.x ? e = ne.min.x : e < ne.max.x && (e = ne.max.x), t > ne.min.y ? t = ne.min.y : t < ne.max.y && (t = ne.max.y)), he.x = e, he.y = t, De()
                    },
                    ...
                    goTo: function (e) {
                        e = Ee(e);
                        var t = e - p;
                        we = t, p = e, r.currItem = Kt(p), ve -= t, Ve(ye.x * ve), tt(), oe = !1, r.updateCurrItem()
                    },
                    next: function () {
                        r.goTo(p + 1)
                    },
                    ...
                    updateCurrZoomItem: function (e) {
                        if (e && ke("beforeChange", 0), S[1].el.children.length) {
                            var t = S[1].el.children[0];
                            ie = o.hasClass(t, "pswp__zoom-wrap") ? t.style : null
                        } else ie = null;
                        ne = r.currItem.bounds, w = y = r.currItem.initialZoomLevel, he.x = ne.center.x, he.y = ne.center.y, e && ke("afterChange")
                    },
                    ...
                    updateCurrItem: function (e) {
                        if (0 !== we) {
                            var t, n = Math.abs(we);
                            if (!(e && 2 > n)) {
                                r.currItem = Kt(p), Te = !1, ke("beforeChange", we), n >= s && (h += we + (we > 0 ? -s : s), n = s);
                                for (var i = 0; n > i; i++) we > 0 ? (t = S.shift(), S[s - 1] = t, h++, Le((h + 2) * ye.x, t.el.style), r.setContent(t, p - n + i + 1 + 1)) : (t = S.pop(), S.unshift(t), h--, Le(h * ye.x, t.el.style), r.setContent(t, p + n - i - 1 - 1));
                                if (ie && 1 === Math.abs(we)) {
                                    var o = Kt(E);
                                    o.initialZoomLevel !== y && (ln(o, me), pn(o), Fe(o))
                                }
                                we = 0, r.updateCurrZoomItem(), E = p, ke("afterChange")
                            }
                        }
                    },
                    updateSize: function (t) {
                        if (!be && l.modal) {
                            var n = o.getScrollY();
                            if (_ !== n && (e.style.top = n + "px", _ = n), !t && Ce.x === window.innerWidth && Ce.y === window.innerHeight) return;
                            Ce.x = window.innerWidth, Ce.y = window.innerHeight, e.style.height = Ce.y + "px"
                        }
                        if (me.x = r.scrollWrap.clientWidth, me.y = r.scrollWrap.clientHeight, Ge(), ye.x = me.x + Math.round(me.x * l.spacing), ye.y = me.y, Ve(ye.x * ve), ke("beforeResize"), void 0 !== h) {
                            for (var i, a, u, c = 0; s > c; c++) i = S[c], Le((c + h) * ye.x, i.el.style), u = p + c - 1, l.loop && Jt() > 2 && (u = Ee(u)), a = Kt(u), a && (T || a.needsUpdate || !a.bounds) ? (r.cleanSlide(a), r.setContent(i, u), 1 === c && (r.currItem = a, r.updateCurrZoomItem(!0)), a.needsUpdate = !1) : -1 === i.index && u >= 0 && r.setContent(i, u), a && a.container && (ln(a, me), pn(a), Fe(a));
                            T = !1
                        }
                        w = y = r.currItem.initialZoomLevel, ne = r.currItem.bounds, ne && (he.x = ne.center.x, he.y = ne.center.y, De(!0)), ke("resize")
                    },
                    zoomTo: function (e, t, n, i, r) {
                        t && (w = y, wt.x = Math.abs(t.x) - he.x, wt.y = Math.abs(t.y) - he.y, Re(fe, he));
                        var a = qe(e, !1),
                            s = {};
                        ...
                        _e(s);
                        var c = function (t) {
                            1 === t ? (y = e, he.x = s.x, he.y = s.y) : (y = (e - l) * t + l, he.x = (s.x - u.x) * t + u.x, he.y = (s.y - u.y) * t + u.y), r && r(t), De(1 === t)
                        };
                ...
                kt = {},
                At = function (e, t) {
                    return kt.prevent = !Pt(e.target, l.isClickableElement), ke("preventDragEvent", e, t, kt), kt.prevent
                },
                Ot = function (e, t) {
                ...
                Rt = function (e) {
                    ...
                    return M ? (ce = 0, dt.forEach(function (e) {
                        0 === ce ? Nt[0] = e : 1 === ce && (Nt[1] = e), ce++
                    })) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Nt[0] = Ot(e.touches[0], Lt), e.touches.length > 1 && (Nt[1] = Ot(e.touches[1], Vt))) : (Lt.x = e.pageX, Lt.y = e.pageY, Lt.id = "", Nt[0] = Lt), Nt
                },
                _t = function (e, t) {
                    var n, i, o, a, s = 0,
                        u = he[e] + t[e],
                        ...
                        d = yt.x + t.x,
                        p = yt.x - pt.x;
                    return n = u > ne.min[e] || u < ne.max[e] ? l.panEndFriction : 1, u = he[e] + t[e] * n, !l.allowPanToNext && y !== r.currItem.initialZoomLevel || (ie ? "h" !== re || "x" !== e || Z || (c ? (u > ne.min[e] && (n = l.panEndFriction, s = ne.min[e] - u, i = ne.min[e] - fe[e]), (0 >= i || 0 > p) && Jt() > 1 ? (a = d, 0 > p && d > pt.x && (a = pt.x)) : ne.min.x !== ne.max.x && (o = u)) : (u < ne.max[e] && (n = l.panEndFriction, s = u - ne.max[e], i = fe[e] - ne.max[e]), (0 >= i || p > 0) && Jt() > 1 ? (a = d, p > 0 && d < pt.x && (a = pt.x)) : ne.min.x !== ne.max.x && (o = u))) : a = d, "x" !== e) ? void(oe || Q || y > r.currItem.fitRatio && (he[e] += t[e] * n)) : (void 0 !== a && (Ve(a, !0), Q = a !== pt.x), ne.min.x !== ne.max.x && (void 0 !== o ? he.x = o : Q || (he.x += t.x * n)), void 0 !== a)
                },
                zt = function (e) {
                    if (!("mousedown" === e.type && e.button > 0)) {
                        if (Qt) return void e.preventDefault();
                        if (!Y || "mousedown" !== e.type) {
                            if (At(e, !0) && e.preventDefault(), ke("pointerDown"), M) {
                            ...
                            var n = Rt(e),
                                i = n.length;
                            K = null, tt(), B && 1 !== i || (B = ae = !0, o.bind(window, m, r), q = ue = se = $ = Q = U = X = Z = !1, re = null, ke("firstTouchStart", n), Re(fe, he), pe.x = pe.y = 0, Re(ut, n[0]), Re(ct, ut), pt.x = ye.x * ve, ft = [{
                                x: ut.x,
                                y: ut.y
                            }], j = H = Ae(), qe(y, !0), St(), Et()), !J && i > 1 && !oe && !Q && (w = y, Z = !1, J = X = !0, pe.y = pe.x = 0, Re(fe, he), Re(at, n[0]), Re(st, n[1]), Mt(at, st, bt), wt.x = Math.abs(bt.x) - he.x, wt.y = Math.abs(bt.y) - he.y, ee = te = Tt(at, st))
                        }
                    }
                },
                Ht = function (e) {
                    ...
                    if (K) {
                        ...
                        if (0 !== e)
                            if (Re(at, K[0]), lt.x = at.x - ut.x, lt.y = at.y - ut.y, J && e > 1) {
                                ...
                                Re(st, K[1]), Z || (Z = !0, ke("zoomGestureStarted"));
                                var t = Tt(at, st),
                                    n = Bt(t);
                                ...
                                if (o > n)
                                    if (l.pinchToClose && !ue && w <= r.currItem.initialZoomLevel) {
                                        var s = o - n,
                                            u = 1 - s / (o / 1.2);
                                        Oe(u), ke("onPinchClose", u), se = !0
                                    } else i = (o - n) / o, i > 1 && (i = 1), n = o - i * (o / 3);
                                else n > a && (i = (n - a) / (6 * o), i > 1 && (i = 1), n = a + i * o);
                                0 > i && (i = 0), ee = t, Mt(at, st, vt), pe.x += vt.x - bt.x, pe.y += vt.y - bt.y, Re(bt, vt), he.x = Ne("x", n), he.y = Ne("y", n), q = n > y, y = n, De()
                            } else {
                                if (!re) return;
                                if (ae && (ae = !1, Math.abs(lt.x) >= rt && (lt.x -= K[0].x - ct.x), Math.abs(lt.y) >= rt && (lt.y -= K[0].y - ct.y)), ut.x = at.x, ut.y = at.y, 0 === lt.x && 0 === lt.y) return;
                                if ("v" === re && l.closeOnVerticalDrag && !It()) {
                                    pe.y += lt.y, he.y += lt.y;
                                    var c = Ft();
                                    return $ = !0, ke("onVerticalDrag", c), Oe(c), void De()
                                }
                                Dt(Ae(), at.x, at.y), U = !0, ne = r.currItem.bounds;
                                var d = _t("x", lt);
                                d || (_t("y", lt), _e(he), De())
                            }
                    }
                ...
                Wt = function (e) {
                    ...
                    ke("pointerUp"), At(e, !1) && e.preventDefault();
                    var t;
                    if (M) {
                    ...
                    1 === u && Re(ct, s[0]), 0 !== u || re || oe || (t || ("mouseup" === e.type ? t = {
                        x: e.pageX,
                        y: e.pageY,
                        type: "mouse"
                    ...
                    var c = -1;
                    if (0 === u && (B = !1, o.unbind(window, m, r), St(), J ? c = 0 : -1 !== gt && (c = Ae() - gt)), gt = 1 === u ? Ae() : -1, a = -1 !== c && 150 > c ? "zoom" : "swipe", J && 2 > u && (J = !1, 1 === u && (a = "zoomPointerUp"), ke("zoomGestureEnded")), K = null, U || Z || oe || $)
                        if (tt(), W || (W = qt()), W.calculateSwipeSpeed("x"), $) {
                            var d = Ft();
                            if (d < l.verticalDragRange) r.close();
                                ...
                                nt("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (e) {
                                    he.y = (r.currItem.initialPosition.y - p) * e + p, Oe((1 - f) * e + f), De()
                                }), ke("onVerticalDrag", 1)
                            }
                        } else {
                            if ((Q || oe) && 0 === u) {
                            ...
                            if (!oe) return "swipe" !== a ? void Xt() : void(!Q && y > r.currItem.fitRatio && $t(W))
                        }
                },
                qt = function () {
                    var e, t, n = {
                        ...
                        calculateSwipeSpeed: function (i) {
                            ft.length > 1 ? (e = Ae() - j + 50, t = ft[ft.length - 2][i]) : (e = Ae() - H, t = ct[i]), n.lastFlickOffset[i] = ut[i] - t, n.lastFlickDist[i] = Math.abs(n.lastFlickOffset[i]), n.lastFlickDist[i] > 20 ? n.lastFlickSpeed[i] = n.lastFlickOffset[i] / e : n.lastFlickSpeed[i] = 0, Math.abs(n.lastFlickSpeed[i]) < .1 && (n.lastFlickSpeed[i] = 0), n.slowDownRatio[i] = .95, n.slowDownRatioReverse[i] = 1 - n.slowDownRatio[i], n.speedDecelerationRatio[i] = 1
                        },
                ...
                Yt = function (e, t) {
                    ...
                    var u;
                    i && (p += i, 0 > p ? (p = l.loop ? Jt() - 1 : 0, u = !0) : p >= Jt() && (p = l.loop ? 0 : Jt() - 1, u = !0), (!u || l.loop) && (we += i, ve -= i, n = !0));
                    var c, d = ye.x * ve,
                        f = Math.abs(d - yt.x);
                    return n || d > yt.x == t.lastFlickSpeed.x > 0 ? (c = Math.abs(t.lastFlickSpeed.x) > 0 ? f / Math.abs(t.lastFlickSpeed.x) : 333, c = Math.min(c, 400), c = Math.max(c, 250)) : c = 333, mt === p && (n = !1), oe = !0, ke("mainScrollAnimStart"), nt("mainScroll", yt.x, d, c, o.easing.cubic.out, Ve, function () {
                        tt(), oe = !1, mt = -1, (n || mt !== p) && r.updateCurrItem(), ke("mainScrollAnimComplete")
                ...
                Xt = function () {
                    ...
                    var i, a = 1,
                        s = le;
                    return se && !q && !ue && t > y ? (r.close(), !0) : (se && (i = function (e) {
                        Oe((a - s) * e + s)
            ...
            var Zt, Ut, Gt, Qt, Kt, Jt, en, tn = function (t, n, i, a) {
                    ...
                    var u = i ? l.hideAnimationDuration : l.showAnimationDuration,
                        c = function () {
                            Je("initialZoom"), i ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (Oe(1), n && (n.style.display = "block"), o.addClass(e, "pswp--animated-in"), ke("initialZoom" + (i ? "OutEnd" : "InEnd"))), a && a(), Qt = !1
                        };
                    if (!u || !s || void 0 === s.x) return ke("initialZoom" + (i ? "Out" : "In")), y = t.initialZoomLevel, Re(he, t.initialPosition), De(), e.style.opacity = i ? 0 : 1, Oe(1), void(u ? setTimeout(function () {
                        c()
                    }, u) : c());
                    var f = function () {
                        var n = d,
                            a = !r.currItem.src || r.currItem.loadError || l.showHideOpacity;
                        t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (y = s.w / t.w, he.x = s.x, he.y = s.y - N, r[a ? "template" : "bg"].style.opacity = .001, De()), et("initialZoom"), i && !n && o.removeClass(e, "pswp--animated-in"), a && (i ? o[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
                            ...
                            if (ke("initialZoom" + (i ? "Out" : "In")), i) {
                                var r = s.w / t.w,
                                    ...
                                    p = le,
                                    f = function (t) {
                                        1 === t ? (y = r, he.x = s.x, he.y = s.y - _) : (y = (r - d) * t + d, he.x = (s.x - l.x) * t + l.x, he.y = (s.y - _ - l.y) * t + l.y), De(), a ? e.style.opacity = 1 - t : Oe(p - t * p)
                                    };
                                n ? nt("initialZoom", 0, 1, u, o.easing.cubic.out, f, c) : (f(1), Zt = setTimeout(c, u + 20))
                            } else y = t.initialZoomLevel, Re(he, t.initialPosition), De(), Oe(1), a ? e.style.opacity = 1 : Oe(1), Zt = setTimeout(c, u + 20)
                        }, i ? 25 : 90)
                    };
                    f()
                },
                ...
                ln = function (e, t, n) {
                    if (e.src && !e.loadError) {
                        ...
                        if (i && (e.vGap || (e.vGap = {
                                top: 0,
                                bottom: 0
                            }), ke("parseVerticalMargin", e)), nn.x = t.x, nn.y = t.y - e.vGap.top - e.vGap.bottom, i) {
                            var o = nn.x / e.w,
                                r = nn.y / e.h;
                            e.fitRatio = r > o ? o : r;
                            var a = l.scaleMode;
            ...
            Se("Controller", {
                publicMethods: {
                    lazyLoadItem: function (e) {
                        e = Ee(e);
                        var t = Kt(e);
                        t && (!t.loaded && !t.loading || T) && (ke("gettingData", e, t), t.src && cn(t))
                    },
                    initController: function () {
                        o.extend(l, rn, !0), r.items = Ut = n, Kt = r.getItemAt, Jt = l.getNumItemsFn, en = l.loop, Jt() < 3 && (l.loop = !1), Pe("beforeChange", function (e) {
                            var t, n = l.preload,
                                i = null === e || e >= 0,
                                o = Math.min(n[0], Jt()),
                                a = Math.min(n[1], Jt());
                        ...
                        }), Pe("mainScrollAnimComplete", fn), Pe("initialZoomInEnd", fn), Pe("destroy", function () {
                    ...
                    setContent: function (e, t) {
                        ...
                        ke("gettingData", t, a), e.index = t, e.item = a;
                        ...
                        if (!a.src && a.html && (a.html.tagName ? s.appendChild(a.html) : s.innerHTML = a.html), dn(a), ln(a, me), !a.src || a.loadError || a.loaded) a.src && !a.loadError && (i = o.createEl("pswp__img", "img"), i.style.opacity = 1, i.src = a.src, pn(a, i), un(t, a, s, i, !0));
                            ...
                            if (a.loadComplete = function (n) {
                                    if (u) {
                                        if (e && e.index === t) {
                                            if (dn(n, !0)) return n.loadComplete = n.img = null, ln(n, me), Fe(n), void(e.index === p && r.updateCurrZoomItem());
                                            n.imageAppended ? !Qt && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : z.transform && (oe || Qt) ? on.push({
                                                item: n,
                                                baseDiv: s,
                                                img: n.img,
                                                index: t,
                            ...
                            a.loading || cn(a), r.allowProgressiveImg() && (!Gt && z.transform ? on.push({
                                item: a,
                                baseDiv: s,
                                img: a.img,
                                index: t,
                        ...
                        Gt || t !== p ? Fe(a) : (ie = s.style, tn(a, i || a.img)), e.el.innerHTML = "", e.el.appendChild(s)
                    },
            ...
            Se("DesktopZoom", {
                publicMethods: {
                    ...
                    setupDesktopZoom: function (t) {
                        ...
                        Pe("resize", a), Pe("afterChange", a), Pe("pointerDown", function () {
                            r.mouseZoomedIn && (i = !0, o.addClass(e, "pswp--dragging"))
                        }), Pe("pointerUp", s), t || a()
                    },
                    handleMouseWheel: function (e) {
                        if (y <= r.currItem.fitRatio) return l.modal && (!l.closeOnScroll || Ke || B ? e.preventDefault() : O && Math.abs(e.deltaY) > 2 && (d = !0, r.close())), !0;
            ...
            var yn, wn, bn, xn, Cn, Tn, Sn, En, In, Pn, kn, An, On = {
                    history: !0,
                    galleryUID: 1
                },
                Mn = function () {
                ...
                Ln = function () {
                    if (bn && clearTimeout(bn), Ke || B) return void(bn = setTimeout(Ln, 500));
                    xn ? clearTimeout(wn) : xn = !0;
                    var e = p + 1,
                        t = Kt(p);
                    t.hasOwnProperty("pid") && (e = t.pid);
                    var n = Sn + "&gid=" + l.galleryUID + "&pid=" + e;
                    En || -1 === kn.hash.indexOf(n) && (Pn = !0);
                    var i = kn.href.split("#")[0] + "#" + n;
                    An ? "#" + n !== window.location.hash && history[En ? "replaceState" : "pushState"]("", document.title, i) : En ? kn.replace(i) : kn.hash = n, En = !0, wn = setTimeout(function () {
                        xn = !1
                    }, 60)
                };
            Se("History", {
                publicMethods: {
                    initHistory: function () {
                        if (o.extend(l, On, !0), l.history) {
                            kn = window.location, Pn = !1, In = !1, En = !1, Sn = Mn(), An = "pushState" in history, Sn.indexOf("gid=") > -1 && (Sn = Sn.split("&gid=")[0], Sn = Sn.split("?gid=")[0]), Pe("afterChange", r.updateURL), Pe("unbindEvents", function () {
                                o.unbind(window, "hashchange", r.onHashChange)
                            });
                            var e = function () {
                                Tn = !0, In || (Pn ? history.back() : Sn ? kn.hash = Sn : An ? history.pushState("", document.title, kn.pathname + kn.search) : kn.hash = ""), Dn()
                            };
                            Pe("unbindEvents", function () {
                                d && e()
                            }), Pe("destroy", function () {
                    ...
                    onHashChange: function () {
                        return Mn() === Sn ? (In = !0, void r.close()) : void(xn || (Cn = !0, r.goTo(Fn().pid), Cn = !1))
                    },
                    updateURL: function () {
                        Dn(), Cn || (En ? yn = setTimeout(Ln, 800) : Ln())
                    }
                }
            }), o.extend(r, it)
        };
        ...
        "use strict";
        var e = function (e, t) {
            var n, i, o, r, a, s, l, u, c, d, p, f, h, m, v, g, y, w, b, x = this,
                C = !1,
                T = !0,
                S = !0,
                E = {
                ...
                I = function (e) {
                    ...
                    for (var n, i, o = e.target || e.srcElement, r = o.getAttribute("class") || "", a = 0; a < $.length; a++) n = $[a], n.onTap && r.indexOf("pswp__" + n.name) > -1 && (n.onTap(), i = !0);
                    if (i) {
                ...
                V = 0,
                N = function () {
                    clearTimeout(b), V = 0, c && x.setIdle(!1)
                },
                R = function (e) {
                    e = e ? e : window.event;
                ...
                W = function () {
                    v.timeToIdle && d("mouseUsed", function () {
                        t.bind(document, "mousemove", N), t.bind(document, "mouseout", R), w = setInterval(function () {
                            V++, 2 === V && x.setIdle(!0)
                        }, v.timeToIdle / 2)
                    })
                },
                    ...
                    var e, n, o, r = function (i) {
                        if (i)
                            for (var r = i.length, a = 0; r > a; a++) {
                                e = i[a], n = e.className;
                                for (var s = 0; s < $.length; s++) o = $[s], n.indexOf("pswp__" + o.name) > -1 && (v[o.option] ? (t.removeClass(e, "pswp__element--disabled"), o.onInit && o.onInit(e)) : t.addClass(e, "pswp__element--disabled"))
                            }
                    };
                    r(i.children);
            ...
            x.init = function () {
                t.extend(e.options, E, !0), v = e.options, i = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, q(), d("beforeChange", x.update), d("doubleTap", function (t) {
                    ...
                    S || M(), w && clearInterval(w), t.unbind(document, "mouseout", R), t.unbind(document, "mousemove", N), t.unbind(i, "pswpTap click", I), t.unbind(e.scrollWrap, "pswpTap", x.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", x.onMouseOver), n && (t.unbind(document, n.eventK, x.updateFullscreen), n.isFullscreen() && (v.hideAnimationDuration = 0, n.exit()), n = null)
                }), d("destroy", function () {
                ...
                }), d("parseVerticalMargin", j), Y(), v.shareEl && s && l && (S = !0), A(), W(), _(), z()
